...
module.exports = {
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            ...
            'process.env.API_HOST': '"' + (process.env.API_HOST || 'http://demo6926047.mockable.io') + '"',
            ...
            'process.env.PROJECT_HOST': '"' + (process.env.PROJECT_HOST || 'http://demo6926047.mockable.io/projects') + '"',
